...
- **Поле зрения — своё**, с полем зрения камеры не связано: по умолчанию
  ...
  (в режиме отрицательных углов 96°), дальность 0.05–30 м. Сенсор стоит в
  камере и наклоняется вместе с ней, но видит и то, что позади неё:
  случайная поза кадра из датасета становится позой лидара, а облако
  захватывает всё окружение.
